...
// While these IDs can be publicly exposed, care should
// be take to regularly cycle your tokens

// Ideally, your token is encrypted if it must be committed or it is added at build
