...
class DatadogFlutterPlugin: FlutterPlugin, MethodCallHandler {
    ...
    when (call.method) {
        "initWithClientToken" -> {
          ...
          var configBuilder = Configuration.Builder(
            logsEnabled = true,
            tracesEnabled = true,
            crashReportsEnabled = rumApplicationId != null,
            rumEnabled = rumApplicationId != null
          )
          if (call.argument<Boolean>("useEUEndpoints")!!) {
            configBuilder = configBuilder.useSite(DatadogSite.EU1)
          }
        ...
        "loggerLog" -> {
          ...
          val attributes = call.argument<Map<String, Any>>("attributes") ?: HashMap<String, Any>();
